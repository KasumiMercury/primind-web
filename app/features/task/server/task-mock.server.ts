...
export function createTaskMockTransport() {
    ...
    return createRouterTransport(({ service }) => {
        service(TaskService, {
            createTask: (req) =>
                withMockOverride("task", "createTask", () =>
            ...
            listActiveTasks: (req) =>
                withMockOverride("task", "listActiveTasks", () =>
            ...
            updateTask: (req) =>
                withMockOverride("task", "updateTask", () =>
                    withErrorInjection("task", "updateTask", () => {
                        ...
                        const updatedTask = create(TaskSchema, {
                            ...existingTask,
                        });
            ...
            deleteTask: (req) =>
                withMockOverride("task", "deleteTask", () =>
